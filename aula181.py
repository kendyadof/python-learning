...
# random.seed(time.time()) # isso é oq o python usa padrao basicamente
# random.seed(0) # ao usar 0, inicializa as aleatoriedades baseada em zero
# e portanto nao randomiza mais nada
# print(time.time())
