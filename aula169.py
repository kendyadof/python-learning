...
caminho = os.path.join("C:\\","Users","Pepe","Documents","pyLearning1","aula1.py")
# consegui fazer funcionar: precisava botar duas barras dps do disco C:
# //
# print(caminho)
# print(os.path.split(caminho))
diretorio, arquivo = os.path.split(caminho)
caminho_arquivo, extensao_arquivo = os.path.splitext(arquivo) # separar a extensão
